...
public class CAPI implements Library {
  ...
  public static native AnnisAnnotation.ByReference annis_vec_annotation_get(AnnisVec_AnnisAnnotation ptr, NativeLong i);
  ...
  public static native AnnisError annis_cs_import_relannis(AnnisCorpusStorage cs, String corpusName,
      String path);
  ...
  public static native void annis_graphupdate_delete_node_label(AnnisGraphUpdate ptr, String node_name, String anno_ns,
      String anno_name);
  ...
  public static native void annis_graphupdate_delete_edge(AnnisGraphUpdate ptr, String source_node, String target_node,
      String layer, String component_type, String component_name);

  public static native void annis_graphupdate_add_edge_label(AnnisGraphUpdate ptr, String source_node,
      String target_node, String layer, String component_type, String component_name, String anno_ns, String anno_name,
      String anno_value);
