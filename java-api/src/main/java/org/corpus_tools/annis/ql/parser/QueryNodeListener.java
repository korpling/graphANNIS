...
public class QueryNodeListener extends AqlParserBaseListener {
  ...
  protected static String textFromSpec(AqlParser.TextSpecContext txtCtx) {
    if (txtCtx instanceof AqlParser.EmptyExactTextSpecContext
        || txtCtx instanceof AqlParser.EmptyRegexTextSpecContext) {
      return "";
  ...
  protected static QueryNode.TextMatching textMatchingFromSpec(AqlParser.TextSpecContext txt, boolean not) {
    ...
    } else if (txt instanceof AqlParser.RegexTextSpecContext || txt instanceof AqlParser.EmptyRegexTextSpecContext) {
