[![Build Status Linux & MacOS X](https://travis-ci.org/thomaskrause/graphANNIS.svg?branch=rust/develop)](https://travis-ci.org/thomaskrause/graphANNIS) (Linux & MacOS X)
