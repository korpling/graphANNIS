...
{
  ANNIS_EXEC_QUERY(Cat, getDB(), 373436u);
}
...
{
  ANNIS_EXEC_QUERY(BilharzioseSentence, getDB(), 21u);
}
...
{
  ANNIS_EXEC_QUERY(NNPreARTPreNN, getDB(), 114042u);
}
...
{
  ANNIS_EXEC_QUERY(RegexDom, getDB(), 36294u);
}
